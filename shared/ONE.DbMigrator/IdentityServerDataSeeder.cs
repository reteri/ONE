using concierge.DbMigrator.Model;
...
namespace ONE.DbMigrator
{
    public class IdentityServerDataSeeder : ITransientDependency
    {
            ...
            IEnumerable<string> corsOrigins = null)
        {
            ...
            if (postLogoutRedirectUris is null)
            {
                throw new ArgumentNullException(nameof(postLogoutRedirectUris));
            }

            //if (string.IsNullOrEmpty(frontChannelLogoutUri))
            //{
            //    throw new ArgumentException($"'{nameof(frontChannelLogoutUri)}' cannot be null or empty.", nameof(frontChannelLogoutUri));
            //}
